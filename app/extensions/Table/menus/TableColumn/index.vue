...
<template>
  ...
  }" :updateDelay="150" pluginKey="tableColumnMenu">
    <div
      ...
      <ActionButton :action="onAddColumnBefore" :tooltip-options="{
        sideOffset: 15,
      }" icon="i-lucide-between-horizontal-end" :tooltip="$t('editor.table.menu.add_column_before')" />
      <ActionButton :action="onAddColumnAfter" :tooltip-options="{
        sideOffset: 15,
      }" icon="i-lucide-between-horizontal-start" :tooltip="$t('editor.table.menu.add_column_after')" />

      <ActionButton :action="onDeleteColumn" :tooltip-options="{
        sideOffset: 15,
      }" icon="i-lucide-trash-2" :tooltip="$t('editor.table.menu.delete_column')" />
